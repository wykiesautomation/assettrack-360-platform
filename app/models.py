...
class Device(db.Model):
    ...
    active=db.Column(db.Boolean,default=True); last_seen=db.Column(db.DateTime(timezone=True)); firmware=db.Column(db.String(100)); capabilities=db.Column(db.JSON,default=list)
